    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.kontingen.index') }}"
                class="nav-link {{ request()->routeIs('admin.kontingen.*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.kategori-lomba.index') }}"
                class="nav-link {{ request()->routeIs('admin.kategori-lomba.*') ? 'active' : '' }}">
                <i class="fas fa-trophy"></i> Kategori Lomba
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.subkategori-lomba.index') }}"
                class="nav-link {{ request()->routeIs('admin.subkategori-lomba.*') ? 'active' : '' }}">
                <i class="fas fa-award"></i> Subkategori
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.kelompok-usia.index') }}"
                class="nav-link {{ request()->routeIs('admin.kelompok-usia.*') ? 'active' : '' }}">
                <i class="fas fa-child"></i> Kelompok Usia
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.kelas-tanding.index') }}"
                class="nav-link {{ request()->routeIs('admin.kelas-tanding.*') ? 'active' : '' }}">
                <i class="fas fa-weight"></i> Kelas Tanding
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.pertandingan.index') }}"
                class="nav-link {{ request()->routeIs('admin.pertandingan.*') ? 'active' : '' }}">
                <i class="fas fa-calendar-alt"></i> Pertandingan
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.jadwal-pertandingan.index') }}"
                class="nav-link {{ request()->routeIs('admin.jadwal-pertandingan.*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.laporan.peserta') }}"
                class="nav-link {{ request()->routeIs('admin.laporan.peserta') ? 'active' : '' }}">
                <i class="fas fa-clipboard-list"></i> Laporan Peserta
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('admin.laporan.pembayaran') }}"
                class="nav-link {{ request()->routeIs('admin.laporan.pembayaran') ? 'active' : '' }}">
